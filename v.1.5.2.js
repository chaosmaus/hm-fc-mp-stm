  ...
  const renderMap = () => {
    ...
    map.on("load", function () {
      ...
      for (const feature of stores.features) {
        ...
        el.innerHTML = `<div class="card-marker_text" >$</div>  <div class="card-marker_text" id="markerPerNight" >${perNightPrice}</div> <div class="marker-guesty">${feature.properties.guesty}</div> `
